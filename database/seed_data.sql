...
('admin',    @admin_hash,   1, 'System Administrator', 'admin@fitlife.pk',    '03001234567', NULL, 1),
('manager1', @mgr_hash,     2, 'Ali Hassan',           'manager1@fitlife.pk', '03011234567', 1,    1),
('manager2', @mgr_hash,     2, 'Bilal Raza',           'manager2@fitlife.pk', '03021234567', 2,    1),
('trainer1', @trainer_hash, 3, 'Usman Farooq',         'trainer1@fitlife.pk', '03031234567', 1,    1),
('trainer2', @trainer_hash, 3, 'Kamran Malik',         'trainer2@fitlife.pk', '03041234567', 1,    1),
('trainer3', @trainer_hash, 3, 'Zeeshan Ahmad',        'trainer3@fitlife.pk', '03051234567', 2,    1),
('trainer4', @trainer_hash, 3, 'Faisal Qureshi',       'trainer4@fitlife.pk', '03061234567', 2,    1),
('member1',  @member_hash,  4, 'Ahmed Siddiqui',       'member1@gmail.com',   '03071234567', 1,    1),
('member2',  @member_hash,  4, 'Hamza Khan',           'member2@gmail.com',   '03081234567', 1,    1),
('member3',  @member_hash,  4, 'Tariq Mahmood',        'member3@gmail.com',   '03091234567', 1,    1),
('member4',  @member_hash,  4, 'Shahid Iqbal',         'member4@gmail.com',   '03101234567', 2,    1),
('member5',  @member_hash,  4, 'Rehan Zafar',          'member5@gmail.com',   '03111234567', 2,    1);
GO
